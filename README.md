...
- Based on Wehrlin, Hallén, and Bassett findings: degradation in speed at VO₂max is approximately linear above **1000 m**.
- Model uses a baseline coefficient of **0.063** (6.3% slowdown per vertical-km) applied only to altitude above 1000 m.
- Inter-athlete variability is large, with approximate **1-sigma variation ~0.025** per vertical-km.
